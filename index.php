            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active"><a href="index.php" class="nav-link">Início</a></li>
                ...
                <div class="container">
                    <div class="row slider-text justify-content-center align-items-center">
                        ...
                        <div class="col-md-7 col-sm-12 text-center ftco-animate">
                            <h1 class="mb-3 mt-5 bread">Pizza's Truffle</h1>
                            <p class="breadcrumbs"><span class="mr-2"><a href="menu.php">Menu</a></span></p>
                        </div>
