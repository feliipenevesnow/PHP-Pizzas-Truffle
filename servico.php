            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a href="servico.php" class="nav-link">Serviços</a></li>
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-7 heading-section ftco-animate text-center">
                        ...
                        <p>Pizza's Truffle, é a melhor no que faz em todos os mínimos detalhes.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 ftco-animate">
                        <div class="media d-block text-center block-6 services">
                            ...
                            <div class="media-body">
                                <h3 class="heading">Ingredientes de Qualidade</h3>
                                <p>Nos preocupamos em escolher os melhores ingredientes para compor nossas pizzas.</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-4 ftco-animate">
                        <div class="media d-block text-center block-6 services">
                            ...
                            <div class="media-body">
                                ...
                                <p>Somos conhecidos pelo delivery mais rápido em nossa região.</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-4 ftco-animate">
                        <div class="media d-block text-center block-6 services">
                            ...
                            <div class="media-body">
                                <h3 class="heading">Sabores Originais</h3>
                                <p>Peça e aproveite os sabores exclúsivos que temos em nossas pizzas.</p>
                            </div>
                        </div>    
                    </div>
                </div>
