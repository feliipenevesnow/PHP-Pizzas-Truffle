                ...
                <div class="row block-9">
                    <div class="col-md-4 contact-info ftco-animate">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <p><span>Endereço:</span> R. José Ramos Júnior, 27-50 - Jardim Tropical, Pres. Epitácio - SP, 19470-000</p>
                            </div>
                            <div class="col-md-12 mb-3">
                                <p><span>Telefone:</span> <a href="tel://1234567920">(018) 3281-9599</a></p>
                            </div>
                            <div class="col-md-12 mb-3">
                                <p><span>Email:</span> <a href="mailto:info@yoursite.com">pizzas@truffle.com</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 ftco-animate">
                        <form action="#" class="contact-form">
                            ...
                            <div class="form-group">
                                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Mensage"></textarea>
                            </div>
                            <div class="form-group">
